...
class TaskResponse
{
    public function __construct(
        ...
        public readonly float|int $priceInWorkerCurrency,
        public readonly float|int $priceWithCommission,
        public readonly float|int $commissionAmount,
        public readonly float|int $commissionAmountInWorkerCurrency,
        ...
        public readonly float|int $fullPriceWithVAT,
